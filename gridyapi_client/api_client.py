...
from gridyapi_client.api_response import ApiResponse, T as ApiResponseT
import gridyapi_client.models
from gridyapi_client import rest
from gridyapi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    This client handles the client-server communication, and is invariant across implementations. Specifics of
    ...
    def __init__(
        ...
        self.user_agent = 'gridy-python-client-v0.5.0'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gridyapi_client.models, klass)
